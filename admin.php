                        ...
                        <div class="card-body movie-body">
                            ...
                            <div class="btns d-flex">
                                ...
                                <form action="editmovie.php">
                                    ...
                                    <button type="submit" name="editmovie" class="btn btn-info edit-btn">Edit</button>
                                </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete "<strong id="movieToDelete"></strong>"?</p>
                </div>
                <div class="modal-footer">
                    <form id="deleteForm" method="POST" action="deletemovie.php">
